(function () {
  ...
  var helper = {
    ...
    calc_padding_top: function calc_padding_top() {
      ...
      if (reveal_slides_count > 0)
        return $window.height() * reveal_slides_count;
      else return 0;
    },
    home_padding_top: function home_padding_top() {
      ...
      if (!bowser.msie)
        $$1(".site .home").css("padding-top", self.calc_padding_top() + "px");
    },
  ...
  var layout = new (function () {
    ...
    this.Grid = new (function () {
      ...
      this.columnWidth = function () {
        return (
          (this.containerWidth() - (COLUMNS_NUMBER - 1) * this.gutterWidth()) /
          COLUMNS_NUMBER
        );
      };
    ...
    createClass(IrregularGrid, [
      ...
      },
      {
        ...
        value: function _showUnrenderedItems() {
          ...
          try {
            for (
              var _iterator = this.parts[Symbol.iterator](), _step;
              ...
              if (part.featured) {
                ...
                var container = $$5(
                  '<div class="grid__row"><div class="item featured"><div class="item-inner"></div></div></div>'
                );
                ...
                if (typeof previousPart !== "undefined") {
                  if (previousPart.featured && previousPart.left) {
                    ...
                    !previousPart.featured &&
                    previousPart.left.bottom > previousPart.right.bottom
                  ) {
                    part.left = false;
                  }
                ...
                if (typeof part.left.container === "undefined") {
                  var container = $$5(
                    '<div class="grid__row two-cols-container"><div class="col-left"><div class="grid__row"></div></div><div class="col-right"><div class="grid__row"></div></div></div>'
                  );
                  container.appendTo(this.section.find(".desktop-container"));
          ...
          if (window.innerWidth >= layout.Breakpoints.lg) {
            this.section
              .find(".desktop-container .lazy-container img")
              .addClass("lazyload");
            return;
          }
        },
    ...
    createClass(PhotosGrid, [
      {
        ...
        value: function init() {
          ...
          var loadMoreItem = this.section.find(".LoadMore");
          if (loadMoreItem.length > 0) {
            this.contentLoader = new ContentLoader(loadMoreItem, function (
              response,
              status,
              xhr
            ) {
  ...
  var drawer = {
    ...
    init: function init() {
      ...
      this.$component.find(".c-drawer__background").hover(
        function () {
          $$8($$8(this).parent().find(".c-drawer__wrapper")[0]).addClass(
            "peaking-out"
          );
        },
        function () {
          $$8($$8(this).parent().find(".c-drawer__wrapper")[0]).removeClass(
            "peaking-out"
          );
        }
      );
  ...
  var ProjectsFilters = {
    ...
    _getCuteNameForFilter: function _getCuteNameForFilter(key, value) {
      return this.$desktopComponent
        ...
        .parent()
        .find(".js-projects-filters-title")
        .html()
        .trim();
    },
    ...
    _updateDOMFromState: function _updateDOMFromState() {
      ...
      this.$filterLabels.each(function (index, labelNode) {
        ...
        if (count == 0) {
          ...
          labelNode.html(
            _this3._getCuteNameForFilter(key, _this3.state[key][0])
          );
        } else {
          labelNode.html(
            labelNode.data("default") +
              "<span class='count'>" +
              count +
              "</sup>"
          );
      ...
      this.$toggleComponent
        .find("[data-selected-options-num]")
        .attr("data-selected-options-num", totalCount);
    },
    ...
    openDesktopFilter: function openDesktopFilter(filterId) {
      ...
      $$9(
        ".js-projects-filters-header-desktop[data-id=" + filterId + "]"
      ...
      this.$categoriesBackground.css(
        "transform",
        "translateY(" + category.outerHeight() + "px)"
      );
    ...
    _handleScroll: function _handleScroll() {
      ...
      if (
        ...
        !this.$desktopComponent.hasClass("is-opened")
      ) {
        return;
      }
      var scrolledDistance = Math.abs(
        position - this.componentOpenedScrollPosition
      );
  ...
  var GoogleMap = new (function () {
    ...
    this.realInit = function () {
      ...
      $updateMarker.on("click", function (ev) {
        ...
        $seeOnGoogleMaps.attr(
          "href",
          $updateMarker.data("google-maps-link") || "#0"
        );
    ...
    this.showMap = function () {
      ...
      if ($$10(".js-az-side-panel-cover").length) {
        ...
        $$10(".c-projects-list-side-panel__right .js-az-side-panel-cover").each(
          function (index) {
            var id = $$10(this).data("project-id"),
              ...
              img = $$10("[data-panel-id='project-" + id + "']")
                .find("img")
                .data("srcset")
                .split(",")[1]
                .split(" ")[0],
        ...
        var markers = locations.map(function (location, i) {
          var newMarker = new google.maps.Marker({
            ...
            icon: {
              path:
                "M6.5 0A6.52 6.52 0 0 0 0 6.53C0 10.14 6.5 17 6.5 17S13 10.14 13 6.53A6.52 6.52 0 0 0 6.5 0zm0 9.7A3.7 3.7 0 1 1 10.19 6 3.71 3.71 0 0 1 6.5 9.7z",
              strokeColor: "#F00",
              fillColor: "#F00",
              fillOpacity: 1,
          ...
          var contentString =
            '<a id="content" class="c-infowindow__content" href="' +
            location.link +
            '">\n                    <div class="c-infowindow__img" style="background-image: url(\'' +
            location.img +
            '\');"></div>\n                    <div class="c-infowindow__txt text"><div class="text--bold">' +
            location.title +
            "</div>" +
            location.sector +
            "</div></a>";
  ...
  var carousel_mixed_image_wrap = $$14(
    ".carousel--mixed .carousel__item-inner .image-wrap"
  );
  ...
  var options = {
    multi:
      ...
      defineProperty(_multi, "lazyLoad", 2),
      defineProperty(_multi, "selectedAttraction", 0.01),
      defineProperty(_multi, "friction", 0.15),
      _multi),
    ...
    gallery:
      ...
      defineProperty(_gallery, "lazyLoad", 1),
      defineProperty(_gallery, "wrapAround", true),
      _gallery),
    ...
    mixed:
      ...
      defineProperty(_mixed, "lazyLoad", 2),
      defineProperty(_mixed, "percentPosition", false),
      defineProperty(_mixed, "cellAlign", "center"),
      _mixed),
    ...
    single:
      ...
      defineProperty(_single, "lazyLoad", 1),
      defineProperty(_single, "percentPosition", false),
      defineProperty(_single, "cellAlign", "center"),
      _single),
  };
  ...
  var slider = {
    ...
    set_mixed_height: function set_mixed_height() {
      ...
      carousel_mixed_image_wrap.each(function () {
        max_height =
          max_height > $$14(this).height() ? max_height : $$14(this).height();
      });
  ...
  var nav = {
    ...
    open_sub_menu: function open_sub_menu() {
      ...
      $$16(".l-nav--main .menu-item-has-children > a").on("click", function (
        e
      ) {
        self.loadImages();
    ...
    open_mobile_sub_menu: function open_mobile_sub_menu() {
      $document.on(
        "click",
        ".l-nav--mobile .menu-item-has-children",
        function () {
    ...
    menu_image_fade: function menu_image_fade() {
      $$16(".l-nav--main .sub-menu .menu-image-title").on(
        "mouseover",
        function () {
          z_index = z_index + 1;
  ...
  var project = {
    ...
    set_widths: function set_widths() {
      ...
      $$21(".sgrid--project__item-6").each(function () {
        $$21(this).css(
          "width",
          $$21(".sgrid--project__item-1").width() + offset + "px"
        );
      });
      ...
      $$21(".sgrid--project__item-10").each(function () {
        $$21(this).css(
          "width",
          $$21(".sgrid--project__item-3").width() + offset + "px"
        );
      });
    },
    calc_offset_left: function calc_offset_left() {
      var offset_left =
        $$21(".sgrid--project__item-1").width() -
        $$21(".sgrid--project__item-3").width();
  ...
  var pushy = {
    ...
    toggle: function toggle($item, $trigger) {
      ...
      if (
        pushy.els.body.hasClass("pushy-active") &&
        pushy.els.active !== $item.selector &&
        pushy.els.active.selector !== $item.selector &&
        $item.selector !== ".pushy-active-item"
      ) {
    ...
    toggle_item: function toggle_item($item) {
      pushy.els.body.toggleClass(
        pushy.vars.classes[$item.data("pushy-direction")].active
      );
      pushy.els.html.toggleClass(
        pushy.vars.classes[$item.data("pushy-direction")].active
      );
      ...
      if (!pushy.vars.css_transforms_3d) {
        ...
        if (pushy.fallback.item_showing) {
          item_args[$item.data("pushy-direction")] =
            -$item.data("pushy-width") + "px";
  ...
  var scroll = {
        ...
        if (helper.breakpoint.large.matches) {
          trans_header.each(function () {
            ...
            header.css({
              ...
              "-webkit-transform":
                "translate3d(0, " + $window.scrollTop() / 4 + "px, 0)",
            });
      ...
      if (slides.length > 0) {
        ...
        for (var $i = 0; $i <= slides.length; $i++) {
          ...
          if (scroll_top + elem_height >= scroll_distance) {
            ...
            $$23(
              ".reveal-slider__slide .reveal-slider__scale .lazy-container"
          ...
          if ($$23(slides[$i]).hasClass("current")) {
            max_height =
              elem_height -
              ((elem_height / 2) * scroll_top) / (elem_height / 2) +
              elem_height * $i;
            $$23(
              ".reveal-slider__slide.current .reveal-slider__scale .lazy-container"
            ).css({
              transform:
                "translate3d(0, -" +
                (scroll_top - elem_height * $i) / 6 +
                "px, 0)",
              "-webkit-transform":
                "translate3d(0, -" +
                (scroll_top - elem_height * $i) / 6 +
    ...
    title_switcher: function title_switcher() {
      ...
      if (project.length > 0) {
        ...
        if (
          $$23(".featured-project--1").offset().top - $window.scrollTop() <=
          $window.height() / 2
        ) {
          title_span.show();
        } else {
        ...
        if (
          $window.scrollTop() >=
          $document.height() - ($window.height() + $$23(".l-footer").height())
        ) {
          title_span.hide();
        }
      }
    ...
    detect_scroll_direction: function detect_scroll_direction() {
      if ($$23(".full-bleed-header").length > 0) {
        var header = $$23(".l-header"),
          ...
          offset = $$23("body").hasClass("home")
            ? parseInt(home_offset, 10)
            : $window.height();
      ...
      if (preloader.length > 0) {
        ...
        if (scale > scale_stop) {
          preloader_logo.css({
            ...
            "-webkit-transform":
              "scale( " + scale + ") translate3d(0, -50%, 0)",
            visibility: "visible",
          });
          ...
          preloader_logo.css({
            ...
            "-webkit-transform":
              "scale( " + scale_stop + ") translate3d(0, -50%, 0)",
            visibility: "hidden",
          });
  ...
  AbstractSwiper.prototype._getSelectorForComponent = function (component) {
    return (
      ".swiper-" + component + '[data-swiper="' + this._options.name + '"]'
    );
  };
  ...
  AbstractSwiper.prototype._getMaxPos = function () {
    ...
    return Math.max(
      0,
      this._getSlideableWidth() -
        this._getValueFromOptions("containerSize") +
        this._getValueFromOptions("snapOffset") +
        this._getValueFromOptions("snapOffsetRight")
    );
  };
  ...
  AbstractSwiper.prototype.getSlideOrientation = function (i) {
    ...
    if (rightEdge < leftContainerEdge) {
      ...
      leftEdge <= leftContainerEdge &&
      rightEdge >= rightContainerEdge
    ) {
      return 0;
    } else if (
      leftEdge >= leftContainerEdge &&
  ...
  AbstractSwiper.prototype.getSlidePercentOfVisibility = function (i) {
    ...
    if (rightEdge < leftContainerEdge) {
      ...
      return (
        (rightEdge - leftContainerEdge) /
        this._getValueFromOptions("slideSize", i)
      );
    } else if (rightEdge >= rightContainerEdge) {
      return (
        (rightContainerEdge - leftEdge) /
        this._getValueFromOptions("slideSize", i)
      );
    }
  };
  ...
  AbstractSwiper.prototype.getSlidePosition = function (i) {
    return (
      -this._pos +
      this._getValueFromOptions("snapOffset", i) +
      this._slideState[i] * this._getSlideableWidth() +
      this._getSlideInitPos(i)
    );
  };
  ...
  AbstractSwiper.prototype._getClosestSnappedPosition = function (pos, side) {
    ...
    if (side == 1 && result < pos) {
      ...
      var newResult =
        result -
        this._getSlideInitPos(index) +
        this._getSlideInitPos(this._getSlideFromOffset(1));
  ...
  AbstractSwiper.prototype.getActiveSlide = function () {
    ...
    for (var i = 0; i < this._options.count; i++) {
      var diff = Math.abs(
        this.getSlidePosition(i) - this._getValueFromOptions("snapOffset", i)
      );
  ...
  AbstractSwiper.prototype._unblockScrolling = function () {
    if (this._mc) {
      var hammerDirection =
        this._options.direction == AbstractSwiper.HORIZONTAL
  ...
  AbstractSwiper.prototype.enable = function () {
    ...
    this._mc = new Hammer(
      document.querySelector(this._getSelectorForComponent("touch-space")),
      {
        domEvents: false,
      }
    );
    ...
    _this._mc.on(
      "pan panup pandown panleft panright panstart panend swipe swipeleft swiperight swipeup swipedown",
      function (ev) {
        ...
        var delta =
          _this._options.direction == AbstractSwiper.HORIZONTAL
            ? ev.deltaX
            : ev.deltaY;
  ...
  AbstractSwiper.prototype.goToNext = function (animated) {
    if (this._options.numberOfItemsMovedAtOneAction == null) {
      this.moveTo(
        this._getClosestSnappedPosition(
          this._pos + this._getValueFromOptions("containerSize")
        )
      );
      return;
    }
    ...
    this.goTo(
      this._getSlideFromOffset(this._options.numberOfItemsMovedAtOneAction()),
      animated,
      1
    );
  };
  ...
  AbstractSwiper.prototype._updatePos = function (pos) {
    ...
    if (this._options.infinite) {
      ...
      for (var i = 0; i < this._options.count; i++) {
        ...
        positions[i] =
          -normalizedPos + this._getValueFromOptions("snapOffset", i);
      }
    }
    ...
    if (
      typeof this._activeSlide === "undefined" ||
  ...
  AbstractSwiper.prototype.deinitComponents = function () {
    ...
    if (this._clickSpaceNext) {
      this._clickSpaceNext.removeEventListener(
        "click",
        this._clickSpaceNextOnClickListener
      );
    }

    if (this._clickSpacePrevious) {
      this._clickSpacePrevious.removeEventListener(
        "click",
        this._clickSpacePreviousOnClickListener
      );
    }
    ...
    if (this._pagerItems) {
      for (var i = 0; i < this._pagerItems.length; i++) {
        ...
        if (i == 0) {
          this._pagerItems[i].removeEventListener(
            "click",
  ...
  AbstractSwiper.prototype.initComponents = function () {
    ...
    // Arrows
    this._clickSpacePrevious = document.querySelector(
      this._getSelectorForComponent("click-space-previous")
    );
    this._clickSpaceNext = document.querySelector(
      this._getSelectorForComponent("click-space-next")
    );
    ...
    if (this._clickSpaceNext) {
      ...
      _this._clickSpaceNext.addEventListener(
        "click",
        this._clickSpaceNextOnClickListener
      );
    }
    ...
    if (this._clickSpacePrevious) {
      ...
      _this._clickSpacePrevious.addEventListener(
        "click",
        this._clickSpacePreviousOnClickListener
      );
    }
    ...
    //Pager
    this._pagerItemTemplate = document.querySelector(
      this._getSelectorForComponent("pager-item")
    );

    if (this._pagerItemTemplate) {
      for (var i = 0; i < this._options.count - 1; i++) {
        var pagerItem = this._pagerItemTemplate.cloneNode(true);
        this._pagerItemTemplate.parentNode.insertBefore(
          pagerItem,
          this._pagerItemTemplate.nextSibling
        );
      }
    }

    this._pagerItems = document.querySelectorAll(
      this._getSelectorForComponent("pager-item")
    );
    ...
    for (var i = 0; i < this._pagerItems.length; i++) {
      (function (i) {
        ...
        _this._pagerItems[i].addEventListener(
          "click",
          _this._pagerItemsOnClickListeners[i]
        );
      })(i);
    }

    // Counter
    this._counterAll = document.querySelector(
      this._getSelectorForComponent("counter-all")
    );
    this._counterCurrent = document.querySelector(
      this._getSelectorForComponent("counter-current")
    );
  ...
  AbstractSwiper.prototype._componentsUpdate = function () {
    ...
    if (this._clickSpaceNext) {
      ...
      if (
        !this._options.infinite &&
        this.getActiveSlide() == this._options.count - 1
      ) {
    ...
    if (this._counterCurrent) {
      this._counterCurrent.innerHTML = this._options.counterTransformer(
        this.getActiveSlide() + 1
      );
    }

    if (this._counterAll) {
      this._counterAll.innerHTML = this._options.counterTransformer(
        this._options.count
      );
    }
  };
  ...
  var videosSlider = {
    init: function init() {
      ...
      function setContainerSize() {
        ...
        containerInner.css(
          "height",
          (bigSlideSize() - padding * 2) * 0.5625 + "px"
        );
        videos.css({
      ...
      function layoutSlides() {
        for (var i = 0; i < videos.length; i++) {
          ...
          var x =
            ((absolutePositions[i] - smallSnapOffset()) / smallSlideSize()) *
              bigSlideSize() +
            (window.innerWidth - bigSlideSize()) * 0.5;
      ...
      function minify() {
        ...
        carousel.css(
          "transform",
          "scale(" + smallSlideSize() / bigSlideSize() + ")"
        );
      }
  ...
  var section_media_awards = {
    init: function init() {
      ...
      function setItemPosition() {
        ...
        item.elem.css(
          "transform",
          "translateX(" + left + "px) translateY(" + bottom + "px)"
        );
      }
      ...
      $$28(".media-awards .award .project a").hover(
        function () {
  ...
  var ui = {
    ...
    set_tabs_container_height: function set_tabs_container_height() {
      var elementHeights = $$29(".tab__content")
        .map(function () {
      ...
      if (anchors_nav.length > 0) {
        ...
        anchors_items.click(function (e) {
          var href = $$29(this).attr("href"),
            offsetTop =
              href === "#" ? 0 : $$29(href).offset().top - header_height + 1;
  ...
  var overlayGallery = new (function () {
    ...
    this._addEventListeners = function () {
      ...
      _this2.$tag.on("click", function () {
        ...
        var $selectedGallery = $$31(
          '[data-photoswipe-grid="' + $$31(this).data("photoswipe-tag") + '"]'
        );
      ...
      _this2.$gridGallery.on("click", "[data-photoswipe-category]", function (
        e
      ) {
        e.preventDefault();
        ...
        var newSlides = [];
        var $images = $$31(
          "[data-photoswipe-grid=" +
            $$31(this).data("photoswipe-category") +
            "]"
        ).find("[data-photoswipe-category]");
    ...
    this.open = function () {
      ...
      _this2.pswp.listen("beforeResize", function () {
        realViewportWidth =
          _this2.pswp.viewportSize.x * window.devicePixelRatio;
      ...
      _this2.pswp.listen("gettingData", function (index, item) {
        ...
        var photoRatio =
          item.sizes[item.sizes.length - 1].w /
          item.sizes[item.sizes.length - 1].h;
        ...
        for (var _i = 0; _i < item.sizes.length; _i++) {
          ...
          if (
            size.w > photoInGalleryWidth * 2 ||
            _i === item.sizes.length - 1
          ) {
      ...
      _this2.$component
        .find("[download]")
        .attr("href", _this2.pswp.currItem.src);
    };
    ...
    this._setCursor = function (e) {
      ...
      if (e.clientX < middle) {
        $$31(".cursor-right:not(.c-photoswipe-cursor)").removeClass(
          "cursor-right"
        );
        $$31(target).addClass("cursor-left");
        $$31(".pswp__container").addClass("cursor-left");
      } else {
        $$31(".cursor-left:not(.c-photoswipe-cursor)").removeClass(
          "cursor-left"
        );
    ...
    this._imageCanBeZoomed = function (e) {
      var target = e.target;
      var photoswipeHasZoomAllowed = _this2.$pswp.hasClass(
        "pswp--zoom-allowed"
      );
    ...
    this._cloneImagesToGrid = function () {
      ...
      _this2.$images.each(function (index, node) {
        ...
        var photoswipeSizes = JSON.stringify(
          $$31($img[0]).data("photoswipe-sizes")
        );
        ...
        customDiv = $$31(
          "<div data-img-grid-index='" +
            imgIndex +
            "' data-id='" +
            photoswipeID +
            "' data-photoswipe-category='" +
            photoswipeCat +
            "' data-photoswipe-sizes='" +
            photoswipeSizes +
            "' class='pswp__trigger js-close-drawer-hook' />"
        );
        $img = customDiv.append($img);
  ...
  var azPanel = {
    ...
    $leftPanelProjectName: $$34(
      ".js-az-panel-left[data-panel-id=project-name]"
    ),
    ...
    showLeftPanelProject: function showLeftPanelProject(projectId) {
      ...
      var panel = $$34(
        ".js-az-panel-left[data-panel-id=project-" + projectId + "]"
      );
      ...
      if (!bowser.tablet && !bowser.mobile) {
        ...
        this.$coverLink.hover(
          function (ev) {
            ...
            if (
              _this.$rightPanel.find(".js-az-side-panel-cover.is-disabled")
                .length === 0
            ) {
    ...
    scrollList: function scrollList(el) {
      ...
      var value =
        $scrollableArea.find('[data-letter="' + $el.text() + '"]').offset()
          .top -
        $$34(document).scrollTop() +
        $scrollableArea.scrollTop() -
        this.$categoriesMenu.outerHeight();
  ...
  var Categories = {
    ...
    $elementsToFilter: $$35(
      $$35("[data-categories-target]").data("categories-target")
    ...
    init: function init() {
      ...
      this.$component.on("click", "[data-category]", function (e) {
        ...
        $$35(this)
          .closest("[data-categories-target]")
          .find("[data-category]")
        ...
        if ($$35(this).closest(".js-accordion-element").length) {
          ...
          var categoryName = $$35(this)
            .parent()
            .find(".js-projects-filters-mobile-name")
            .text();
  ...
  var utils = {
    ...
    debug_lazy_img_sizes: function debug_lazy_img_sizes() {
      ...
      function putActualSize(lazy_container) {
        ...
        var loaded_width = lazy_container
          .find(".lazy-debugger__img-loaded")
          .data("loaded");
        var efficiency = Math.ceil((width / loaded_width) * 1000) / 10;

        lazy_container
          .find(".lazy-debugger .lazy-debugger__img-ratio")
          .html("ratio&nbsp;&nbsp;" + ratio + "vw");
        lazy_container
          .find(".lazy-debugger .lazy-debugger__img-width")
          .html("width&nbsp;&nbsp;" + width + "px");
        lazy_container
          .find(".lazy-debugger .lazy-debugger__img-efficiency")
          .html("eff&nbsp;&nbsp;&nbsp;&nbsp;" + efficiency);
      }
      ...
      $$37(".lazy-container img").load(function () {
        ...
        var loaded_width =
          parseInt(src.substr(width_index + 3, s_index - width_index - 3), 10) /
          device_pixel_density;

        $$37(this)
          .closest(".lazy-container")
          .find(".lazy-debugger__img-loaded")
          .html(
            "loaded " +
              loaded_width +
              "px" +
              (device_pixel_density > 1 ? " retina" : "")
          );
        $$37(this)
          .closest(".lazy-container")
          .find(".lazy-debugger__img-loaded")
          .data("loaded", loaded_width);
        refresh();
      });
    },
    ...
    match_element_viewport_height: function match_element_viewport_height() {
      ...
      if (!helper.breakpoint.large.matches) {
        ...
        $$37(".fill-viewport .container--vh").css(
          "height",
          css_viewport_height
        );
        ...
        $$37(".reveal-slider__slide-overlay").css(
          "height",
          css_viewport_height
        );
      }
      ...
      function setOffsets() {
        if (window.innerWidth < layout.Breakpoints.lg) {
          ...
          $$45(".c-meet-body__offset-getter").each(function () {
            var height = $$45(this)
              .closest(".c-meet-body__item")
              .find(".c-meet-body__offset-maker")
              .outerHeight();
  ...
  (function ($, document) {
    ...
    var app = {
      ...
      load: function load() {
        ...
        if (ib_elem.length > 0) {
          ib_offset_top =
            ib_elem.offset().top - ($(window).height() / 100) * 40;
        }
